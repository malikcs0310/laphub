    ...
    return (
      <div className="flex gap-0.5">
        {[1, 2, 3, 4, 5].map((star) => (
          <FiStar
            key={star}
            className={`text-xs ${star <= rating ? "text-yellow-400 fill-yellow-400" : "text-gray-300"}`}
          />
        ))}
      </div>
    );
    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              <FiMessageCircle className="text-purple-500 text-xl" />
              <h2 className="text-lg font-bold text-gray-900">
            ...
            <tbody>
              {recentOrders.map((order) => (
                ...
                >
                  ...
                  <td className="py-3">
                    <span
                      className={`px-2 py-1 rounded-full text-xs font-medium ${statusColors[order.orderStatus]}`}
                    >
                      {order.orderStatus}
                    </span>
                  </td>
